    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, int ViewType) {
            ...
            if (ViewType == TYPE_ITEM) {
                ...
                Holderid = 1;                                               // Set holder id as 1 as the object being populated is of type item row
            } else {

                Name = itemView.findViewById(R.id.name);
                email = itemView.findViewById(R.id.email);
                profile = itemView.findViewById(R.id.circleView);
                Holderid = 0;                                                // Set holder id = 0 as the object being populated is of type header view
            }
        }
    }
